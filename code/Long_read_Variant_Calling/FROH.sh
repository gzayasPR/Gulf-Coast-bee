...
HOM_KB=100                 # --homozyg-kb
HOM_SNP=30               # --homozyg-snp
HOM_DENSITY=50            # --homozyg-density (kb/SNP inside ROH)
...
############################################
{
  ...
  echo "PLINK ROH: kb=${HOM_KB} snp=${HOM_SNP} density=${HOM_DENSITY} gap=${HOM_GAP} win_snp=${HOM_WIN_SNP} win_het=${HOM_WIN_HET} win_miss=${HOM_WIN_MISS} win_thresh=${HOM_WIN_THRESH}"
...
# PLINK .hom columns include POS1 (field 5) and POS2 (field 6) in bp; length_bp = POS2 - POS1 + 1
