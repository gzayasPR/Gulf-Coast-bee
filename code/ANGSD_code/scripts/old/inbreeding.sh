...
cat ${bam_filelist}
bam_filelist="${ANGSD_results}/ANGSD_out/femalesfemale_bam.filelist"
...
### run NgsRelate
$ngsRelate_dir/ngsRelate/ngsRelate -g ${out_dir}/combined.glf.gz -n 18 -f ${out_dir}/freq -F 1 -O ${out_dir}/newres
