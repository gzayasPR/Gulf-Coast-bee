...
$angsd_dir/misc/realSFS -fold 1 "${out_dir}/$individual.saf.idx"  -maxIter 100 -tole 1e-12  > "${out_dir}/$individual.angsd.sfs"
  ...
  $angsd_dir/angsd -i "$bam_file" \
    ...
    -minQ 20 \
    -minMapQ 30 \
    -pest  "${out_dir}/$individual.angsd.sfs" \
    -out "${out_dir}/$individual.l"
    
# Estimate heterozygosity
$angsd_dir/misc/realSFS -fold 1 "${out_dir}/$individual.l.saf.idx"  -maxIter 100 -tole 1e-12  > "${out_dir}/$individual.est.ml"
