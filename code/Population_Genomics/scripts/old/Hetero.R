...
results.dir <- paste(proj.dir, "/results/Population_Genomics/Genetic_Diversity/DeepVariant/", sep="")
...
filtered_vcf_path <-  paste(data.dir ,"/Females_Hesperapis_oraria_Hetero.filtered.vcf",sep="")
...
data.dir <- paste(proj.dir, "/data/variants/DeepVariant/", sep="")
results.dir <- paste(proj.dir, "/results/Population_Genomics/Genetic_Diversity/DeepVariant/", sep="")
vcf_path <-  paste(data.dir ,"/Females_Hesperapis_oraria_Hetero.filtered.vcf",sep="")
