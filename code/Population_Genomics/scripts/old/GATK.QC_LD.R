...
setwd(proj.dir)
data.dir <- paste(proj.dir, "/data/variants/GATK/", sep="")
...
data= data.frame(x = c(dp2_matrix ))

plot <- ggplot()+ geom_histogram(aes(data$x),breaks=c(0,9,seq(10,15,by=1),seq(16,30,by=5),seq(31,100, by=10))) + scale_x_continuous(breaks=c(0,9,seq(10,15,by=1),seq(16,30,by=5),seq(31,100, by=10)))
